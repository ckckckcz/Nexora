...
class MahasiswaChatController extends Controller
{
    public function sendMessage(Request $request)
    {
        ...
        $user = Auth::user();
        if ($user->role !== 'mahasiswa' || $user->mahasiswa->id_mahasiswa != $request->sender_id) {
    ...
    public function getMessages($room)
    {
        ...
        // Check if the mahasiswa is part of this bimbingan
