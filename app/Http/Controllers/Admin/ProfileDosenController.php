...
class ProfileDosenController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.manajemenProfile.dosen', compact('lecturers'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.function.profile_dosen.tambah', compact('prodis'));
    }
    ...
    public function edit(string $id)
    {
        ...
        $prodis = ProgramStudi::all();
        return view('admin.function.profile_dosen.edit', compact('dosen', 'prodis'));
    }
