...
<div class="flex flex-col min-h-screen md:flex-row">
    <!-- Login Form Section -->
    <div class="flex items-center justify-center w-full p-8 md:w-1/2 md:p-12 lg:p-16">
        <div class="w-full max-w-2xl">
            <div class="mb-12 transition duration-500 transform">
                <h1 class="relative inline-block mb-3 text-4xl font-bold text-gray-800">
                    Masuk 📃
                    <div class="absolute -bottom-1 left-0 w-1/2 h-1 bg-[#DEFC79] rounded-full"></div>
                </h1>
                <p class="text-lg text-gray-600">
                    Sudah Punya Akun? 
                    <a href="/daftar" class="relative inline-block font-medium text-blue-900 hover:text-blue-950 group">
                        Daftar
                    </a>
                </p>
            </div>
            
            <form method="POST" action="{{ url('login') }}" class="space-y-8">
                @csrf
                <div class="form-floating-group">
                    <div class="relative">
                        ...
                        <label for="username" 
                            class="absolute text-sm text-gray-500 transition-all duration-300 left-4 top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-placeholder-shown:top-6 peer-focus:top-4 peer-focus:text-black peer-focus:text-sm">
                            Username
                        </label>
                        <div class="absolute text-gray-400 right-4 top-6">
                ...
                <div class="form-floating-group">
                    <div class="relative">
                        ...
                        <button type="button" id="togglePassword" class="absolute text-gray-400 transition-colors duration-200 right-4 top-6 hover:text-gray-600 focus:outline-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor" id="eyeIcon">
                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                                <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" class="hidden w-5 h-5" viewBox="0 0 20 20" fill="currentColor" id="eyeOffIcon">
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full bg-[#DEFC79] text-black cursor-pointer font-medium py-4 px-6 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 flex items-center justify-center group">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-transform duration-300 transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="relative my-10">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 py-1 text-gray-500 bg-white rounded-full">Atau Login Dengan</span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <button class="flex items-center justify-center py-3 px-4 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 group">
                    <svg class="w-5 h-5 mr-2 transition-transform duration-300 group-hover:scale-110" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="mt-10 text-sm text-center text-gray-600 transition-opacity duration-300 hover:opacity-80">
                By joining you agree to the System logo LMS<br>
                <a href="#" class="text-blue-900 underline transition-colors duration-200 hover:text-blue-950 underline-offset-2 hover:underline">Terms of service</a> and 
                <a href="#" class="text-blue-900 underline transition-colors duration-200 hover:text-blue-950 underline-offset-2 hover:underline">Privacy Policy</a>
            </p>
        </div>
    </div>
