        ...
        <div class="flex items-center justify-center w-full p-8 md:w-1/2 md:p-12 lg:p-16">
            <div class="w-full max-w-2xl">
                <div class="mb-12 transition duration-500 transform">
                    ...
                    <p class="text-gray-700 mt-3 max-w-md">Welcome to the Nexora: Your Comprehensive Resource for
                ...
                <form method="POST" action="{{ url('login') }}" class="space-y-8">
                    ...
                    <div class="form-floating-group">
                        <div class="relative">
                            ...
                            <button type="button" id="togglePassword"
                                class="absolute text-gray-400 transition-colors duration-200 right-4 top-6 hover:text-gray-600 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="hidden w-5 h-5" viewBox="0 0 20 20"
                                    fill="currentColor" id="eyeOffIcon">
                                    <path fill-rule="evenodd"
                    ...
                    <div class="pt-2">
                        <button type="submit"
                            class="w-full bg-[#DEFC79] text-black cursor-pointer font-medium py-4 px-6 rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 flex items-center justify-center group">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <button
                        class="flex items-center justify-center py-3 px-4 border border-gray-200 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 group">
                        <svg class="h-5 w-5 mr-2 text-[#1877F2] transition-transform duration-300 group-hover:scale-110"
                ...
                <p class="mt-10 text-sm text-center text-gray-600 transition-opacity duration-300 hover:opacity-80">
                    ...
                    <a href="#"
                        class="text-blue-900 underline transition-colors duration-200 hover:text-blue-950 underline-offset-2 hover:underline">Terms
                        of service</a> and
                    <a href="#"
                        class="text-blue-900 underline transition-colors duration-200 hover:text-blue-950 underline-offset-2 hover:underline">Privacy
                        Policy</a>
                </p>
            </div>
        </div>
