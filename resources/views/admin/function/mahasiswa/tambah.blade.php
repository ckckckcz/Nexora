...
@section('admin')
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        <header class="mb-8">
            <h1 class="text-3xl font-bold text-blue-900">Tambah Data Mahasiswa 🧑🏽‍🎓</h1>
        </header>

        <section class="bg-white rounded-2xl border border-gray-200 transition-shadow duration-300 hover:shadow-lg">
            <div class="p-4 sm:p-6 flex flex-col gap-6">
                <form action="/admin/manajemen-akun/mahasiswa/tambah" method="POST" class="flex flex-col gap-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input type="text" id="nama_mahasiswa" name="nama_mahasiswa"
                                class="block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-200"
                                placeholder="Masukkan Nama Mahasiswa" required maxlength="100">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="jenis_kelamin" value="L"
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 transition-opacity duration-200" required>
                                <span class="text-sm text-gray-700 transition-colors duration-200">Laki-laki</span>
                            </label>
                            <label class="flex items-center gap-2">
                                <input type="radio" name="jenis_kelamin" value="P"
                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 transition-opacity duration-200">
