                ...
                <form action="/admin/sistem-rekomendasi/manajemen-kriteria/tambah" method="POST" class="flex flex-col gap-6">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" name="nama_kriteria" id="nama_kriteria"
                            ...
                            placeholder="Masukkan nama kriteria" value="{{ old('nama_kriteria', $kriteria->nama_kriteria)}}"  required>
                        @error('nama_kriteria')
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="4" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-300 text-gray-700 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-900/20 focus:border-blue-900 transition-all duration-200">{{ $kriteria->keterangan }}</textarea>
                        @error('keterangan')
                            <span class="text-sm text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
