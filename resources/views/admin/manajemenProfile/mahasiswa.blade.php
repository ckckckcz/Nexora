...
@section('admin')
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        <header class="mb-8">
            <h1 class="text-3xl font-bold text-blue-900">Manajemen Profile Mahasiswa 🧑🏽‍🎓</h1>
            <p class="mt-2 text-gray-600 font-medium">Kelola data profil mahasiswa</p>
        </header>
        ...
        <section class="bg-white rounded-2xl border border-gray-200">
            <div class="p-4 sm:p-6 flex flex-col gap-4">
                <div class="flex flex-col lg:flex-row sm:items-left sm:justify-between gap-4">
                    ...
                    <!-- Add Student Button -->
                    <a href="/admin/profile/mahasiswa/tambah">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody iid="table-body" class="bg-white divide-y divide-gray-200">
                            @if ($colleges === null)
                            @else
                                @foreach ($colleges as $college)
                                    <tr>
                                        ...
                                        <td class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                            <a href="/admin/profile/mahasiswa/edit/{{ $college->id_mahasiswa }}"
                                            ...
                                            <form action="/admin/profile/mahasiswa/hapus/{{ $college->id_mahasiswa }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
