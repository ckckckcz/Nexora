    ...
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        ...
        <section class="bg-white rounded-2xl border border-gray-200 p-4 sm:p-6">
            ...
            <table class="min-w-full divide-y divide-gray-200 mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($matriks as $row)
                        <tr>
                            @if(is_array($row) && isset($row['nama_perusahaan']))
                                <td class="px-4 py-4 text-sm text-gray-900">{{ $row['nama_perusahaan'] }}</td>
                            @else
                                <td class="px-4 py-4 text-sm text-gray-900">Invalid Data</td>
                            @endif
                            @foreach ($kriteria as $k)
            ...
            <table class="min-w-full divide-y divide-gray-200 mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($bestValues as $kriteriaId => $value)
                        <tr>
            ...
            <table class="min-w-full divide-y divide-gray-200 mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($worstValues as $kriteriaId => $value)
                        <tr>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $kriteriaId }}</td>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $value }}</td>
                        </tr>
            ...
            <table class="min-w-full divide-y divide-gray-200 mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($sValues as $row)
                        <tr>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $row['nama_perusahaan'] }}</td>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $row['s'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="min-w-full divide-y divide-gray-200 mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($rValues as $row)
                        <tr>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $row['nama_perusahaan'] }}</td>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $row['r'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="min-w-full divide-y divide-gray-200 mb-8">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($qValues as $row)
                        <tr>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $row['nama_perusahaan'] }}</td>
                            <td class="px-4 py-4 text-sm text-gray-900">{{ $row['q'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
