...
@section('admin')
    ...
    <div class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Sistem Rekomendasi Magang</p>
        </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Total Rekomendasi Sukses</dt>
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-bold text-blue-900" data-stat="totalSuccess">328</div>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Jumlah Aplikasi Magang</dt>
                                    <dd class="flex items-baseline">
                                        <div class="text-2xl font-bold text-blue-900" data-stat="totalApplications">892
                                        </div>
                                    </dd>
                                </dl>
                            </div>
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="bg-white shadow-lg rounded-xl p-6 transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-sm font-medium text-blue-900 hover:text-blue-700 transition-colors">Lihat
                            semua</a>
                    </div>
                    <div class="flow-root">
