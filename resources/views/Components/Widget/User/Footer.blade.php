<footer class="bg-blue-900 text-white py-12 px-6 lg:px-12">
    <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Hire Work</a></li>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Forums</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div class="mt-6">
                    <div class="flex">
                        <input type="email" placeholder="Enter your email here" class="px-4 py-2 w-full rounded-l-md focus:outline-none text-gray-800">
                        <button class="bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-r-md transition-colors">
        ...
        <div class="mt-12 pt-8 border-t border-blue-800 text-center text-gray-300 text-sm">
