            ...
            <div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                        <div class="flex justify-between items-center mb-4">
                            <h2 class="text-lg font-bold text-gray-900">About Me</h2>
                            <button class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                Edit
                            </button>
                        </div>
                        <p class="text-gray-700">
                            With a strong foundation in software development and a keen eye for user experience, I am
                            passionate about creating intuitive and engaging digital experiences. Currently pursuing a
                            degree in Informatics Engineering at State Polytechnic of Malang, I specialize in frontend web
                            development and UI/UX design.
                        </p>
                        <p class="text-gray-700 mt-4">
                            As a member of Workshop Riset Informatika, I collaborate with peers on innovative projects that
                            solve real-world problems. I'm particularly enthusiastic about Framer for prototyping and
                            design, and I'm constantly expanding my skills in modern web technologies.
                        </p>
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-gray-200">
                        ...
                        <div class="mb-8">
                            <div class="flex">
                                ...
                                <div>
                                    <h3 class="text-base font-semibold text-gray-900">Frontend Developer Intern</h3>
                                    <p class="text-sm text-gray-600">TechSolutions Indonesia</p>
                                    <p class="text-sm text-gray-500">Jun 2023 - Aug 2023 · 3 months</p>
                                    <p class="mt-2 text-sm text-gray-700">
                                        Developed responsive web interfaces using React.js and Tailwind CSS. Collaborated
                                        with the design team to implement UI/UX improvements that increased user engagement
                                        by 25%.
                                    </p>
                        ...
                        <div>
                            <div class="flex">
                                ...
                                <div>
                                    <h3 class="text-base font-semibold text-gray-900">UI/UX Design Volunteer</h3>
                                    <p class="text-sm text-gray-600">Workshop Riset Informatika</p>
                                    <p class="text-sm text-gray-500">Jan 2023 - Present</p>
                                    <p class="mt-2 text-sm text-gray-700">
                                        Creating user-centered designs for community projects. Leading design workshops for
                                        junior members and contributing to the organization's design system.
                                    </p>
                                    <div class="mt-3 flex flex-wrap gap-2">
                                        <span
                                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-gray-200">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <!-- Portfolio Item 1 -->
                            <div
                                class="group relative rounded-xl overflow-hidden border border-gray-200 hover:shadow-md transition-all">
                                <div class="aspect-w-16 aspect-h-9">
                                    <img src="https://via.placeholder.com/600x340" alt="E-commerce UI Design"
                                        class="w-full h-full object-cover">
                                </div>
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-900">E-commerce UI Redesign</h3>
                                    <p class="text-sm text-gray-600 mt-1">A complete redesign of an e-commerce platform
                                        focusing on improved user experience and conversion rates.</p>
                                    <div class="mt-3 flex items-center text-sm text-blue-600">
                                        <a href="#" class="font-medium hover:text-blue-800 flex items-center">
                                            View Project
                            ...
                            <div
                                class="group relative rounded-xl overflow-hidden border border-gray-200 hover:shadow-md transition-all">
                                <div class="aspect-w-16 aspect-h-9">
                                    <img src="https://via.placeholder.com/600x340" alt="Mobile App Design"
                                        class="w-full h-full object-cover">
                                </div>
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-900">Educational Mobile App</h3>
                                    <p class="text-sm text-gray-600 mt-1">A React Native mobile application designed to help
                                        students track their learning progress and goals.</p>
                                    <div class="mt-3 flex items-center text-sm text-blue-600">
                                        <a href="#" class="font-medium hover:text-blue-800 flex items-center">
                                            View Project
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-5">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-blue-600 mt-1">Looking for Frontend Development or UI/UX Design roles
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                        ...
                        <div class="mt-3 flex flex-wrap gap-2">
                            <span
                                class="px-3 py-1.5 text-sm bg-gray-100 rounded-lg text-gray-800 font-medium">React.js</span>
                            <span class="px-3 py-1.5 text-sm bg-gray-100 rounded-lg text-gray-800 font-medium">Tailwind
                                CSS</span>
                            <span
                                class="px-3 py-1.5 text-sm bg-gray-100 rounded-lg text-gray-800 font-medium">JavaScript</span>
                            <span class="px-3 py-1.5 text-sm bg-gray-100 rounded-lg text-gray-800 font-medium">UI/UX
                                Design</span>
                            ...
                            <span
                                class="px-3 py-1.5 text-sm bg-gray-100 rounded-lg text-gray-800 font-medium">HTML/CSS</span>
                            <span class="px-3 py-1.5 text-sm bg-blue-100 rounded-lg text-blue-800 font-medium">+5
                                more</span>
                        </div>
                    </div>
