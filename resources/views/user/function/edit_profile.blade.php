            ...
            <form action="/profile/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                        ...
                        <div class="relative group">
                            <img id="profile-preview"
                                ...
                                src="https://randomuser.me/api/portraits/women/44.jpg" alt="Profile Preview">
                ...
                <div class="mt-6 grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="Riovaldo" disabled
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Masukkan deskripsi Anda">Informatics Engineering Student at State Polytechnic of Malang | Frontend Web Developer | UI/UX Designer | Framer Designer Enthusiast | Member of Workshop Riset Informatika</textarea>
                    </div>
                    <!-- Location -->
                    <div>
