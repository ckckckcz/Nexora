<section class="w-full bg-center bg-no-repeat bg-cover bg-[url('https://i.ibb.co.com/1JrpYCGV/profiel-header.png')] h-64 relative">
  ...
  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-26 relative mb-26 z-10">
    <div class="bg-white shadow-md rounded-2xl p-6">
      <!-- Header Profile -->
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div class="flex items-center space-x-6">
          <img class="w-24 h-24 rounded-full border-4 border-[#DEFC79] shadow" src="https://randomuser.me/api/portraits/women/44.jpg" alt="Foto Profil">
          <div>
            <h2 class="text-2xl font-bold text-gray-900">Riovaldo Alfiyan Fahmi Rahman</h2>
            <p class="text-gray-400 text-md font-medium">@ckckckcz</p>
          </div>
        </div>
      ...
      <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
          <div class="bg-gray-50 p-4 rounded-2xl border border-gray-200 shadow-sm"> 
            ...
            <button class="mt-3 text-sm text-blue-600 hover:underline">Learn more →</button>
          </div>
        ...
        <div class="space-y-6">
          ...
          <div class="border border-gray-200 rounded-2xl p-4 bg-white shadow-sm">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <span class="px-2 py-1 text-sm bg-gray-100 rounded">Figma</span>
              <span class="px-2 py-1 text-sm bg-gray-100 rounded">UX Design</span>
              <span class="px-2 py-1 text-sm bg-gray-100 rounded">+8</span>
            </div>
          </div>
          <!-- Locations -->
          <div class="border border-gray-200 rounded-2xl p-4 bg-white shadow-sm">
            ...
            <div class="flex space-x-2">
              ...
              <img src="https://flagcdn.com/w40/dk.png" class="w-6 h-4 rounded-sm" alt="DK">
            </div>
          </div>
          <!-- Contact -->
          <div class="border border-gray-200 rounded-2xl p-4 bg-white shadow-sm">
            ...
            <p class="text-sm text-gray-700">annayoast@theUI.studio</p>
          </div>
        </div>
      </div>
    </div>
