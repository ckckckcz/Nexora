  ...
  <div class="bg-white rounded-2xl shadow-lg p-6 sm:p-8">
      ...
      <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
        ...
        <div>
          ...
          <p class="text-gray-600 mt-1 max-w-2xl">
            Informatics Engineering Student at State Polytechnic of Malang | Frontend Web Developer | UI/UX Designer |
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-8">
        <!-- About Section -->
        @include('components.ui.user.content.about_me')

        <!-- Experience Section -->
        @include('components.ui.user.content.experience')

        <!-- Portfolio Section -->
        @include('components.ui.user.content.portfolio')
      </div>
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
          ...
          <div class="mt-2 flex items-baseline">
            ...
            <span class="ml-2 text-green-600 text-sm font-medium flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-0.5" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
        ...
        <!-- Skills -->
        @include('components.ui.user.content.skills')
        <!-- Education -->
        @include('components.ui.user.content.education')
