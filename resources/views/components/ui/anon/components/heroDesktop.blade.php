...
<div class="grid grid-cols-5 gap-4 w-full items-end team-grid mt-20">
    <div
        class="bg-gray-50 team-card text-black border border-gray-100 shadow-md shadow-[#DEFC79] rounded-3xl pr-4 pt-4 pl-4 flex flex-col justify-between items-center h-[350px] group relative">
    ...
    <div
        class="bg-gray-50 team-card text-black border border-gray-100 shadow-md shadow-[#DEFC79] rounded-3xl pr-4 pt-4 pl-4 flex flex-col justify-between items-center h-[400px] group relative">
        <div class="text-center">
    ...
    <div
        class="bg-gray-50 team-card text-black border border-gray-100 shadow-md shadow-[#DEFC79] rounded-3xl pr-4 pt-4 pl-4 flex flex-col justify-between items-center h-full group relative">
        <div class="text-center">
